...
export class portfolioService {
    private portfolios: Portfolio[] = [
        ...
        new Portfolio("pictures/portfolio/authSystem.jpg", "https://aminepolak.github.io/AuthSystem/", "Formation '20 Projets en Javascript' de Enzo Ustariz sur la plateform Udemy. Création d'un système d'authentification en Js avec Firebase, base de donnée Cloud Firestore. Modale Inscription / Connexion."),
