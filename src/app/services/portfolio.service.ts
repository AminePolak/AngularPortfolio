...
export class portfolioService {
    private portfolios: Portfolio[] = [
        new Portfolio("pictures/portfolio/portfolio.jpg", "https://aminepolak.github.io/AngularPortfolio/", "Création de mon site perso-portfolio en Angular 19. Utilisation Boostrap 5, MailJs"),
        ...
        new Portfolio("pictures/portfolio/portfolio.jpg", "https://aminepolak.github.io/", "Création de mon site perso-portfolio avec les les technologies HTML, CSS, responsivité en BOOTSTRAP, formulaire de contact en PHP et quelques fonctionnalités en JQUERY."),
        ...
        new Portfolio("\pictures/githubAPI.jpg", "https://aminepolak.github.io/GithubApi/", "Formation '20 Projets en Javascript' de Enzo Ustariz sur la plateform Udemy. Création d'une application de recherche de profil Github en javascript. Avec appel d'une API Github, création d'un template HTML dans le JS."),
